...
(*
  ...
  Program Definition applyUF {i} (UF : hoD Σ i -> olty Σ i) (A : olty Σ i) : olty Σ i :=
    Olty (λ args ρ v, UF (λ args v, A args ρ v) args ρ v) _.
  Next Obligation. intros **?**. by rewrite olty_vclosed. Qed.
