...
Section tmem_unstamped_lemmas.
  ...
  (** XXX Convenience lemmas? *)
  Lemma suD_Typ_dsem {Γ l σ s fakeσ} {T : olty Σ 0} (HclT : coveringσ σ T):
  ...
  Proof.
    by iIntros "H1 H2"; iApply (suD_Typ_Stp with "H1 H2"); iApply suD_Typ_dsem.
  Qed.
