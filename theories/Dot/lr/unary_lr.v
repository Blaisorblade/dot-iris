...
[Mu_Stp] over [sMu_Stp].
Due to the fix to [issue #365](https://github.com/Blaisorblade/dot-iris/issues/365),
this must now use non-definitional equalities.
*)
...
Proof.
  ...
  apply (laterN_soundness (M := iResUR Σ) _ i).
