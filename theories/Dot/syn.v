From D Require Import asubst_extras.
From D.Dot Require Export dot_syn.
Instance inj_ids : Inj (=) (=@{vl}) ids := inj_ids.

Definition ValueSort_vl: ValueSort vl. by []. Qed.

Hint Extern 0 (ValueSort _) => by apply ValueSort_vl: typeclass_instances.
Definition Sort_vl_tm: Sort vl tm. by []. Qed.
Hint Extern 0 (Sort _ tm) => by apply Sort_vl_tm: typeclass_instances.

Instance: Inhabited vl := _.
Implicit Types
