...
Section syntyping_stamping_lemmas.
  ...
  - intros * Hps Hus1 Hu1 IHs1 Hu2 IHs2 g.
    ...
    split_and!; first eapply typing_objIdent.App_path_typed; naive_solver eauto 4.
  - intros * Hu1 IHs1 Hu2 IHs2 g.
    move: IHs1 => /(.$ g) [e1' [g1 ?]];
    move: IHs2 => /(.$ g1) [e2' [g2 ?]]; ev; lte g g1 g2.
  ...
  - intros * Hu1 IHs1 Hu2 IHs2 g.
    ...
    exists p, g2; split_and!;
      first eapply typing_objIdent.psingleton_trans; eauto 2.
  - intros * Hu1 IHs1 Hu2 IHs2 g.
    move: IHs1 => /(.$ g) [p1' [g1 ?]];
    ...
    exists (pself p l), g2; split_and!;
      first eapply typing_objIdent.psingleton_elim;
