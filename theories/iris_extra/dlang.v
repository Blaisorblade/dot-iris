  ...
  *)
  ...
  Section mapsto.
    ...
    Proof.
      ...
      iDestruct (saved_pred3_agree _ _ _ with "Hsg1 Hsg2") as "Heq"; iNext.
  ...
  Notation "s ↝ φ" := (s ↝n vopen φ)%I  (at level 20) : bi_scope.
  Notation "s ↗[ σ  ] ψ" := (s ↗n[ σ ] vopen ψ)%I (at level 20) : bi_scope.
End LiftWp.
